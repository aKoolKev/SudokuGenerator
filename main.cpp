...
BUGS
    - missing commas on printing values left
    - allow user to edit row/col selection
    - error handling when accessing invalid cell
    - error handling if acccessing not empty cell
*/
